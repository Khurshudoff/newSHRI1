...
const nav_items = [$('#nav_events'), $('#nav_summary'), $('#nav_devices'), $('#nav_scripts'), $('#nav_video')];
const video_items = [$('#video-1'), $('#video-2'), $('#video-3'), $('#video-4')];

$('#nav_video').on('click', function(event){
...
$("#video1_controls").find(".brightness").on('input', function(){
    $("#video1_controls").find('.brightness_value').text($(this).val());
...
$("#video1_controls").find(".contrast").on('input', function(){
    $("#video1_controls").find('.contrast_value').text($(this).val());
...
$("#video2_controls").find(".brightness").on('input', function(){
    $("#video2_controls").find('.brightness_value').text($(this).val());
...
$("#video2_controls").find(".contrast").on('input', function(){
    $("#video2_controls").find('.contrast_value').text($(this).val());
...
$("#video3_controls").find(".brightness").on('input', function(){
    $("#video3_controls").find('.brightness_value').text($(this).val());
...
$("#video3_controls").find(".contrast").on('input', function(){
    $("#video3_controls").find('.contrast_value').text($(this).val());
...
$("#video4_controls").find(".brightness").on('input', function(){
    $("#video4_controls").find('.brightness_value').text($(this).val());
...
$("#video4_controls").find(".contrast").on('input', function(){
    $("#video4_controls").find('.contrast_value').text($(this).val());
